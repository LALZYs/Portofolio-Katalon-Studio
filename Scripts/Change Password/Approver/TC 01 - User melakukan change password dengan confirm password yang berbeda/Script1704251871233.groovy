...
WebUI.setEncryptedText(findTestObject('Object Repository/Change Password/Approver/input__confirmPassword'), 'Uro0ZodcRWKr5kgSDTkbIA==')

WebUI.click(findTestObject('Change Password/Approver/button_Submit'))
