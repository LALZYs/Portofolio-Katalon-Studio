...
WebUI.setText(findTestObject('Object Repository/Admin/Page_Ofin  Create User/input_failed create user_name'), 'softwaretester')

WebUI.setText(findTestObject('Object Repository/Admin/Page_Ofin  Create User/input__email'), 'testinglagiyuk@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Admin/Page_Ofin  Create User/input__password'), 'WN1AeTw2TpHAken2HtY51g==')

WebUI.setEncryptedText(findTestObject('Object Repository/Admin/Page_Ofin  Create User/input__confirmPassword'), 'WN1AeTw2TpHAken2HtY51g==')

WebUI.click(findTestObject('Object Repository/Admin/Page_Ofin  Create User/button_Submit'))

WebUI.verifyElementVisible(findTestObject('Admin/Page_Ofin  Create User/Page_Ofin  Create User/div_successfully create user'))
